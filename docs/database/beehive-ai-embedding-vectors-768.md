# beehive.ai_embedding_vectors_768

## Purpose

Stores pgvector embeddings with exactly 768 dimensions. This table is used only for embedding records whose dimensions value is 768.
