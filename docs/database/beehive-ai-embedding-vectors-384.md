# beehive.ai_embedding_vectors_384

## Purpose

Stores pgvector embeddings with exactly 384 dimensions. This table is used only for embedding records whose dimensions value is 384.
